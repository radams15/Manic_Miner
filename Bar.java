...
{
    private int barWidth = 797; // the width of the color portion of the bar
    private int barHeight = 45; // the height of the color portion of the bar
    private int breakPercent = 25; // the percentage amount that changes the color of the bar
    ...
    private Color backgroundColor = Color.WHITE; //new Color(0, 0, 0, 0); // the background color of the entire object
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    ...
    private int value = 100; // the current value of the bar
